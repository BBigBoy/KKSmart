...
public final class IjkMediaPlayer extends SimpleMediaPlayer {
    ...
    /**
     * Sets the {@link android.view.SurfaceHolder} to use for displaying the video portion of
     * the media.
     * 
     * Either a surface holder or surface must be set if a display or video sink
     * is needed. Not calling this method or {@link #setSurface(android.view.Surface)} when
    ...
    /**
     * Sets the {@link android.view.Surface} to be used as the sink for the video portion of
     * the media. This is similar to {@link #setDisplay(android.view.SurfaceHolder)}, but
     * does not support {@link #setScreenOnWhilePlaying(boolean)}. Setting a
     * Surface will un-set any Surface or SurfaceHolder that was previously set.
     * A null surface will result in only the audio track being played.
     * 
     * If the Surface sends frames to a {@link android.graphics.SurfaceTexture}, the timestamps
     * returned from {@link android.graphics.SurfaceTexture#getTimestamp()} will have an
     ...
     * 
     * @param surface
     *            The {@link android.view.Surface} to be used for the video portion of the
     *            media.
     */
    @Override
